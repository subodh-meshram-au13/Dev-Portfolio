...
export default function index() {
  const phrase = `Web developer with 4+ years of experience in frontend development using  React,PHP,and Next.js, with a fundamental knowledge of backend technologies like Node.js. Experienced in seamless frontend-backend integration and graphic design, creating visually engaging digital content.`;
  ...
  return (
    ...
    <div ref={description} className={styles.description} id="about">
      ...
      <div>
        ...
        <div className={styles.bodySecond}>
            <h4>
            Web developer | Andex (Part-time), japan | Oct 2023 - March 2023
            </h4>
            <ul>
            <li>
